...
export default function ApplyPage() {
    ...
    return (
      <div className="min-h-[80vh] flex items-center justify-center bg-gray-50 p-4">
        ...
        >
          ...
          <a
            href="/check-visa"
            className="inline-flex items-center text-rts-blue font-semibold hover:text-blue-800 transition-colors"
          >
  ...
  const inputClass =
    "w-full px-4 py-3 rounded-md border border-gray-300 focus:ring-2 focus:ring-rts-blue focus:border-rts-blue outline-none transition-all placeholder:text-gray-400";
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="pt-8 lg:sticky lg:top-24">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Begin your migration journey with RTS Australia. Enter your details
            as they exactly appear on your passport to ensure streamlined
            processing.
          </p>
            ...
            <div className="flex bg-white p-4 rounded-xl shadow-sm border border-gray-100 pl-4 border-l-4 border-l-rts-blue">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  All entries are encrypted and mapped directly to your Passport
                  Number.
                </p>
              </div>
            </div>
            <div className="flex bg-white p-4 rounded-xl shadow-sm border border-gray-100 pl-4 border-l-4 border-l-rts-red">
              <div>
                <h3 className="font-bold text-gray-900">
                  One Passport, One Profile
                </h3>
                <p className="text-sm text-gray-500 mt-1">
                  Our system prevents duplicate filings to ensure total
                  compliance and priority processing.
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Full Name <span className="text-rts-red">*</span>
                </label>
                <input
                  type="text"
                  name="fullName"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Father&apos;s Name <span className="text-rts-red">*</span>
                </label>
                <input
                  type="text"
                  name="fatherName"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Mother&apos;s Name <span className="text-rts-red">*</span>
                </label>
                <input
                  type="text"
                  name="motherName"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Email Address <span className="text-rts-red">*</span>
                </label>
                <input
                  type="email"
                  name="email"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Phone Number <span className="text-rts-red">*</span>
                </label>
                <input
                  type="tel"
                  name="phone"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  NID Number <span className="text-rts-red">*</span>
                </label>
                <input
                  type="text"
                  name="nid"
